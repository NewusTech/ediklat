<div class="modal fade" id="inviteMemberEssayModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <p class="text-md text-bold text-center">Member yang di undang</p>
...
<script>
    ...
    function addMemberToEssay(id) {
        $.ajax({
            url: base_url + 'ediklat/ajax/lms/addMemberToEssay/' + <?php echo $essay['essayCode'] ?> + '/' + id,
            type: "GET",
            success: function(data) {
                if (data.status) {
    ...
    function deleteMemberToEssay(id) {
        $.ajax({
            url: base_url + 'ediklat/ajax/lms/deleteMemberToEssay/' + <?php echo $essay['essayCode'] ?> + '/' + id,
            type: "GET",
            success: function(data) {
                if (data.status) {
                    handleToast("success", data.message);
    ...
    function closeModalInvite() {
        $("#inviteMemberEssayModal").modal('hide');
        peserta();
    }
