<div class="row">
    ...
    <div class="col-md-12 col-sm-12 text-end">
        <button type="button" class="btn btn-sm btn-primary" onclick="updateCertificate(<?php echo $activityCode ?>)">Update</button>
    </div>
...
<script>
    ...
    function updateCertificate(id) {
        $.ajax({
            url: base_url + 'ediklat/ajax/kegiatan/updateCertificate/' + id,
            type: "POST",
            data: {
