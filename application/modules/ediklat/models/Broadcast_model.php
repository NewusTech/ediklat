...
class Broadcast_model extends CI_Model
{
	...
	var $table = 'notif';
	var $column_order = array('notif'); //set column field database for datatable orderable
	var $column_search = array('notif'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('notifCode' => 'desc'); // default order 
	...
	public function delete_by_id($id)
	{
		...
		$this->db->update($this->table, $data, ['notifCode' => $id]);
		return $this->db->affected_rows();
	}
}
