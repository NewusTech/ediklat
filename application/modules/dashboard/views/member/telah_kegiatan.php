...
?>
    <?php if ($total > 3) : ?>
        <div class="col-12 mb-3 selengkapnyaTelah-<?php echo $pageActive ?>">
            <div class="d-flex justify-content-center">
                <a href="javascript:void(0)" class="btn btn-sm btn-primary selengkapnya-<?php echo $pageActive ?>" onclick="getList('telah', <?php echo ($pageActive + 1) ?>)">Selengkapnya</a>
            </div>
        </div>
        <script>
            $('.selengkapnya-<?php echo $pageActive ?>').click(() => {
                $('.selengkapnyaTelah-<?php echo $pageActive ?>').remove();
            });
        </script>
    <?php endif; ?>
<?php endif; ?> 