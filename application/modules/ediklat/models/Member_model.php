...
class Member_model extends CI_Model
{
	...
	private function _get_datatables_query()
	{
		...
		if($this->input->post('state_member') != NULL ){
			$this->db->where('stateCode', $this->input->post('state_member'));
		}

		if($this->input->post('education_service_member') != NULL ){
			$this->db->where('education_service', $this->input->post('education_service_member'));
		}
		$i = 0;
	...
	public function delete_by_id($id)
	{
		...
		$this->db->update($this->table, $data, ['memberCode' => $id]);
		return $this->db->affected_rows();
	}
}
