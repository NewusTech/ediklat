            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <span class="text-danger mt-1 ml-1 text-xs"><?php echo ($this->session->has_userdata('err') ? $this->session->flashdata('err') : '') ?></span>
                            <?php
                            echo form_open(base_url('authentication/register/act_register'), 'role="form text-left"');
                            ?>
                            <div class="mb-3">
                            ...
                            ?>
                            <div class="text-center">
                                <p class="text-xs text-bold">already have an account? <a href="<?php echo base_url('authentication/login') ?>">Sign In Here</a></p>
                            </div>
                        </div>
                    </div>
                </div>
