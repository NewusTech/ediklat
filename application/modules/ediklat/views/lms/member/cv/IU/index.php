<div class="d-flex flex-column flex-lg-row gap-1 justify-content-between align-items-center bg-white rounded py-1 px-1">
    <p class="text-sm text-bold my-auto py-auto">Ubah/Lengkapi Informasi Umum</p>
    <span class="badge bg-primary" role="button" onclick="editIU()"><i class="fa fa-pen"></i> UBAH/LENGKAPI</span>
</div>
