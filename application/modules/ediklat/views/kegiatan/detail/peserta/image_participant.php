...
<div class="modal fade" id="imageModalParticipant" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php if (file_exists(path_by_os(FCPATH . 'assets/img/participant/' . $image))) { ?>
                    <img src="<?php echo base_url('assets/img/participant/' . $image) ?>" class="img-fluid" alt="">
                <?php } else { ?>
                    <img src="<?php echo base_url('assets/img/participant/default.png') ?>" class="img-fluid" alt="">
                <?php } ?>
            </div>
...
<script>
    function closeModalImage() {
        $("#imageModalParticipant").modal('hide');
    }
</script>