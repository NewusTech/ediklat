...
class Peserta_model extends CI_Model
{
	...
	var $column_order = array('name', 'agency'); //set column field database for datatable orderable
	var $column_search = array('name', 'agency'); //set column field database for datatable searchable just firstname , lastname , address are searchable
