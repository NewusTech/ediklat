                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-xs text-bold">Lupa password? <a href="<?php echo base_url('authentication/forgot') ?>">Reset Here</a></p>
                            ...
                            ?>
                            <div class="text-center">
                                <p class="text-xs text-bold">don't have an account? <a href="<?php echo base_url('authentication/register') ?>">Registrasi</a></p>
                            </div>
                        </div>
                    </div>
                </div>
